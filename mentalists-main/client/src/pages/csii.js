  ...
  return (
    <main style={{ backgroundColor: '#F5F6FA', fontFamily: 'sans-serif', padding: '0 1rem' }}>
      ...
      <div dangerouslySetInnerHTML={{
        __html: `
          <meta name="description" content="Centre for Social Impact Initiatives empowering leadership for social change" />
          <meta property="og:title" content="Centre for Social Impact Initiatives - CCAE" />
          <meta property="og:description" content="Empowering leaders for social change through initiatives and capacity building." />
