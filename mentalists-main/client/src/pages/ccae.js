  ...
  return (
    <main style={{ backgroundColor: '#F5F6FA', fontFamily: 'sans-serif', padding: '0 1rem' }}>
      ...
      >
        ...
        >Civil Administrative Fellowship</motion.h1>
      ...
      >
        ...
        >Objectives of this Fellowship</motion.h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
          {[
            ...
            >
              ...
              <div style={{ backgroundColor: '#1E3A8A', color: '#FFFFFF', padding: '1rem', borderRadius: '8px', textAnchor: 'center', width: '100%' }}>
      ...
      >
        ...
        >Key Highlights of the Fellowship</motion.h2>
