  ...
  return (
    <div className="min-h-screen bg-[#FCFDFF] font-sans">
      ...
      <header className="py-8 md:py-10 text-center border-b border-[#d2d5e0]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-col items-center space-y-3">
            <Scale className="h-7 w-7 text-[#023080]" />
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="bg-[#d2d5e0] border border-[#8e9fc5] rounded-md p-6 md:p-8 space-y-6">
          {[
            {
            ...
            <section key={i}>
              <h3 className="text-lg md:text-xl font-semibold text-[#023080] mb-2">
                {section.title}
              </h3>
