        ...
        {/* Social Media Icons */}
            <div className="flex items-center  space-x-4">
              <a
                ...
                onMouseEnter={(e) => (e.target.style.backgroundColor = "#04307b")}
                onMouseLeave={(e) => (e.target.style.backgroundColor = "#8e9fc5")}
              >
                <Facebook size={20} />
              </a>
              <a
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  style={{ color: "#04307b" }}
                  onMouseEnter={(e) => (e.target.style.color = "#023080")}
                  onMouseLeave={(e) => (e.target.style.color = "#04307b")}
                >
                  Our History
                </Link>
              </li>
        ...
        <div className="border-t pt-8" style={{ borderColor: "#d2d5e0" }}>
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mb-4 md:mb-0">
              ...
              <span className="text-sm" style={{ color: "#8e9fc5" }}>
            ...
            {/* Developer Credits */}
            <div className="text-sm mt-4 md:mt-0" style={{ color: "#8e9fc5" }}>
